          ...
          ${s.map((e,t)=>{const i=parseFloat(e.value),l=t<s.length-1?parseFloat(s[t+1].value):n,c=valueToAngle(i,o,n,a,r),d=valueToAngle(l,o,n,a,r),g=parseFloat(e.width)||16,p=parseFloat(e.position)||0,h=e.color_start||"#ffffff",u=e.color_end||h;if(h===u){const e=50+p,t=buildRingPath(c,d,e,e-g,50,50);return svg`<path d="${t}" fill="${h}" />`}const m=(d-c+360)%360;return svg`
              <foreignObject x="0" y="0" width="100" height="100">
                <div
                  ...
                  style="width:100%;height:100%;background:conic-gradient(from ${c}deg at 50% 50%, ${h} 0deg, ${u} ${m}deg, transparent ${m}deg);"
                ></div>
              </foreignObject>
            `})}
        </svg>
